...
<head>
    ...
    <title>AddedUT - Agenda de Eventos Extracurriculares</title>

    {{-- Fuentes: Inter (Moderno, Limpio y Escolar) --}}
    ...
    <main>
        ...
        <div class="events-grid">
            ...
            @php
                ...
                // Simulación: ¿El usuario está inscrito? Reemplazar con lógica real.
                $isEnrolled = ($loop->iteration % 3 == 0);
            @endphp

            <a href="{{ route('eventos.show', $evento->id_evento) }}" class="event-card-tilt">
