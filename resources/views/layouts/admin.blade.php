...
<div id="app" class="app-wrapper">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.testimonios') }}" class="{{ request()->routeIs('admin.testimonios*') ? 'active' : '' }}">
                <i data-feather="star" class="nav-icon"></i> Testimonios
                @php $pendCount = \App\Models\Testimonio::where('aprobado', false)->count(); @endphp
                @if($pendCount > 0)
                    <span style="background:#f59e0b; color:#fff; font-size:.65rem; font-weight:800;
