...
<head>
    ...
    <title>Inicio de Sesión | AddedUT</title>
    ...
    <style>
        /* Variables UTTEC (IDÉNTICAS a Welcome) */
        :root {
            ...
            --color-glass-bg: rgba(255, 255, 255, 0.1); /* Fondo del contenedor de login */
            --color-error: #FF5252;
        }
        ...
        * {
        ...
        /* Fondo del Body (IDÉNTICO a Welcome) */
        body {
        ...
        /* --- Encabezado con Logo (IDÉNTICO a Welcome) --- */
        .header {
            position: absolute;
            top: 25px;
            left: 25px;
        ...
        /* Botón de Ingreso (Verde UTTEC Intenso - Acción Principal) */
        button {
            width: 100%;
            padding: 14px;
            border: none;
...
<body>
    ...
    <div class="header">
        {{-- CORRECCIÓN: Se usa href="/" en lugar de route('welcome') para evitar errores de ruta no definida. --}}
    ...
    <div class="container">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <input type="email" name="email" id="email" placeholder="ej. matricula@uttec.edu.mx" required value="{{ old('email') }}" autofocus>

            <label for="password">Contraseña:</label>
            <input type="password" name="password" id="password" placeholder="••••••••" required>

            <button type="submit">
                <i data-feather="log-in" style="width: 18px; stroke-width: 3;"></i> Ingresar
            </button>
        </form>
        ...
        <a href="{{ route('registro') }}" class="link-registro">
            ¿No tienes cuenta? <span style="font-weight: 700;">Regístrate aquí</span>
        </a>
    </div>
